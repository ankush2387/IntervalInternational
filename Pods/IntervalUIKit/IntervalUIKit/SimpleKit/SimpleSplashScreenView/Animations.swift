...
// MARK: - Class extension to define the basic functionality for the SimpleRevealingAppLaunchView class
public extension SimpleRevealingAppLaunchView {
    ...
    public func playZoomOutAnimation(_ completion: SplashAnimatableCompletion? = nil) {
        ...
        if let imageView =  imageView {
            ...
            UIView.animate(withDuration: growDuration, animations: { [unowned self] in

            ...
            if let viewModel = viewModel {
                ...
                viewModel.isEditing
                    .observeNext { [weak self] editing in
                        ...
                        self?.textField.textColor = !editing ? UIColor(red: 146.0/255.0, green: 146.0/255.0, blue: 146.0/255.0, alpha: 1) : IntervalThemeFactory.deviceTheme.secondaryTextColor
                    }
                    .dispose(in: onReuseBag)
            }
        }

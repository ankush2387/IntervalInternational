//
//  ExchangeProcessEndResponse.swift
//  DarwinSDK
//
...
open class ExchangeProcessEndResponse {
    ...
    open var view : ExchangeProcessEndView?
    ...
    public convenience init(json:JSON) {
        ...
        if let viewJSON = json["view"] as JSON? {
            self.view = ExchangeProcessEndView(json: viewJSON)
        }
    }

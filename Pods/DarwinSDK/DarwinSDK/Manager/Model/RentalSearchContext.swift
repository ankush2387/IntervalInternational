...
open class RentalSearchContext {
    ...
    open func hasInResortCodes() -> Bool {
       return (self.request.resorts.count) > 0
    }
    ...
    open func hasInDestinations() -> Bool {
        return (self.request.destinations.count) > 0
    }
    ...
    open func hasInAreas() -> Bool {
        return (self.request.areas.count) > 0
    }
    ...
    open func hasOutCheckInDates() -> Bool {
        return (self.response.checkInDates.count) > 0
    }
    ...
    open func hasOutSurroundingCheckInDates() -> Bool {
        return hasInDestinations() && (self.response.surroundingCheckInDates.count) > 0
    }
    ...
    open func hasOutResortCodes() -> Bool {
        return (self.response.resortCodes.count) > 0
    }
    ...
    open func hasOutSurroundingResortCodes() -> Bool {
        return hasInDestinations() && (self.response.surroundingResortCodes.count) > 0
    }

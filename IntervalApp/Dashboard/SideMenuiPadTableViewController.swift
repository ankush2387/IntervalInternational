...
class SideMenuiPadTableViewController: UIViewController, UITableViewDataSource {
    ...
    static let SideMenuItems : [SideMenuItemIPad] = [
        ...
        SideMenuItemIPad(title: Constant.sideMenuTitles.ownershipUnits,image:Constant.assetImageNames.ownershipUnits,storyboardid:Constant.storyboardNames.ownershipIphone,initialcontrollername: Constant.sideMenuTitles.sideMenuInitialController),
